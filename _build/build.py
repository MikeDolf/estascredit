...
def render_page(page):
    ...
    if SITE["metrika_id"]:
        metrika = (
            ...
            "\n"
            "    ym(__METRIKA_ID__, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:\"dataLayer\", "
            "referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});\n"
            '</script>\n'
            '<noscript><div><img src="https://mc.yandex.ru/watch/__METRIKA_ID__" '
            'style="position:absolute; left:-9999px;" alt="" /></div></noscript>\n'
            '<!-- /Yandex.Metrika counter -->'
        ).replace("__METRIKA_ID__", str(SITE["metrika_id"]))
